...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Xử lý upload ảnh
        $image = $banner->image; // Giữ nguyên ảnh cũ nếu không upload ảnh mới
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Tên banner <span class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php echo isset($errors['name']) ? 'is-invalid' : ''; ?>" 
                                               name="name" value="<?php echo $banner->title ?>">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <?php if ($banner->image): ?>
                                        <div class="mb-2">
                                            <img src="<?php echo BASE_URL . '/public/' . $banner->image; ?>" alt="Current image" style="max-width: 200px;">
                                        </div>
                                        <?php endif; ?>
