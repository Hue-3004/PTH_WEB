...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($name) || empty($email) || empty($phone) || empty($password) || empty($rePassword)) {
    ...
    if (empty($errors)) {
        try {
            ...
            $success = true;
            $_SESSION['success_register_client'] = "Đăng ký thành công!";
...
<head>
    ...
    <title><?= $system->site_name?> - Đăng ký</title>
    ...
    <div class="login-container">
        <div class="login-box">
            ...
            <div class="login-links">
                ...
                <span>|</span>
                <a href="<?php echo BASE_URL; ?>/login" class="register-link">Đăng nhập tài khoản</a>
            </div>
        </div>
    </div>
